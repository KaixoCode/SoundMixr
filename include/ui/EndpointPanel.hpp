...
//			m_DeviceMenu.Emplace<Button<BG::Menu, BT::List>>([=] { SetDevice(_d); }, name, Vec2<int>{220, 20}, listid);
//		}
//	}
//
...
//		int i = name.find_first_of('(');
//		if (i < name.size()) name.resize(i, ' ');
//		m_DeviceButton.Name(name);
//
//		m_SRButton.Enable();
//		m_BSButton.Enable();
//
//		id = std::to_string(m_Audio.Device().id);
//		m_LoadDeviceData = true;
//	}
//
//	AudioIO& GetAudio() { return m_Audio; }
//	
...
//	std::string id;
//	
//	bool m_LoadDeviceData = false,
//		m_ClosePanel = false;
//	
//	void Render(CommandCollection& d) override
//	{
//		
//		id = std::to_string(m_Audio.avg);
//		Panel::Render(d);
//		if (m_Audio.RtAudio().isStreamOpen())
//		{
//			m_SRButton.Name(std::to_string(m_Audio.RtAudio().getStreamSampleRate()));
