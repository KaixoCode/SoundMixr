...
namespace SoundMixr
{
	...
	public:
			...
			EffectBase("Chorus")
		{
			...
			m_RateKnob.ScalingType(ParameterData::Scaling::Log);
			m_RateKnob.Scaling(2);
			...
			m_Highpass.ScalingType(ParameterData::Scaling::Log);
			m_Highpass.Scaling(10);
